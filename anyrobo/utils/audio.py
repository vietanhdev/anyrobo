...
class AudioProcessor:
    ...
    @staticmethod
    def detect_silence(
        audio: np.ndarray, threshold: float = 0.02, min_duration: int = 10
    ) -> np.ndarray:
    ...
    @staticmethod
    def trim_silence(
        audio: np.ndarray, threshold: float = 0.02, min_silence_duration: int = 1000
    ) -> np.ndarray:
    ...
    @staticmethod
    def resample(audio: np.ndarray, orig_sample_rate: int, target_sample_rate: int) -> np.ndarray:
